  ...
  constructor(...[configuration]) {
    ...
    this.middlewareStack.use(
      (0, import_core.getHttpAuthSchemeEndpointRuleSetPlugin)(this.config, {
        httpAuthSchemeParametersProvider: import_httpAuthSchemeProvider.defaultDocDBHttpAuthSchemeParametersProvider,
...
var de_DBCluster = /* @__PURE__ */ __name((output, context) => {
  ...
  if (output[_DBSG] != null) {
    contents[_DBSG] = (0, import_smithy_client.expectString)(output[_DBSG]);
  }
  if (output[_St] != null) {
...
var throwDefaultError = (0, import_smithy_client.withBaseException)(DocDBServiceException);
...
var paginateDescribeCertificates = (0, import_core.createPaginator)(DocDBClient, DescribeCertificatesCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeDBClusterParameterGroupsPaginator.ts

var paginateDescribeDBClusterParameterGroups = (0, import_core.createPaginator)(DocDBClient, DescribeDBClusterParameterGroupsCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeDBClusterParametersPaginator.ts

var paginateDescribeDBClusterParameters = (0, import_core.createPaginator)(DocDBClient, DescribeDBClusterParametersCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeDBClusterSnapshotsPaginator.ts

var paginateDescribeDBClusterSnapshots = (0, import_core.createPaginator)(DocDBClient, DescribeDBClusterSnapshotsCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeDBClustersPaginator.ts

var paginateDescribeDBClusters = (0, import_core.createPaginator)(DocDBClient, DescribeDBClustersCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeDBEngineVersionsPaginator.ts

var paginateDescribeDBEngineVersions = (0, import_core.createPaginator)(DocDBClient, DescribeDBEngineVersionsCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeDBInstancesPaginator.ts

var paginateDescribeDBInstances = (0, import_core.createPaginator)(DocDBClient, DescribeDBInstancesCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeDBSubnetGroupsPaginator.ts

var paginateDescribeDBSubnetGroups = (0, import_core.createPaginator)(DocDBClient, DescribeDBSubnetGroupsCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeEventSubscriptionsPaginator.ts

var paginateDescribeEventSubscriptions = (0, import_core.createPaginator)(DocDBClient, DescribeEventSubscriptionsCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeEventsPaginator.ts

var paginateDescribeEvents = (0, import_core.createPaginator)(DocDBClient, DescribeEventsCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeGlobalClustersPaginator.ts

var paginateDescribeGlobalClusters = (0, import_core.createPaginator)(DocDBClient, DescribeGlobalClustersCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribeOrderableDBInstanceOptionsPaginator.ts

var paginateDescribeOrderableDBInstanceOptions = (0, import_core.createPaginator)(DocDBClient, DescribeOrderableDBInstanceOptionsCommand, "Marker", "Marker", "MaxRecords");

// src/pagination/DescribePendingMaintenanceActionsPaginator.ts

var paginateDescribePendingMaintenanceActions = (0, import_core.createPaginator)(DocDBClient, DescribePendingMaintenanceActionsCommand, "Marker", "Marker", "MaxRecords");
